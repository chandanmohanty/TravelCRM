...
namespace TravelCrm.Api.Migrations
{
    ...
    [Migration("20260603182553_NormaliseLeadEmail")]
    partial class NormaliseLeadEmail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelCrm.Api.Domain.Entities.Crm.Deal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId", "IsDeleted")
                        .HasDatabaseName("ix_deals_tenant_id_is_deleted");

                    b.HasIndex("TenantId", "LeadId")
                        .HasDatabaseName("ix_deals_tenant_id_lead_id")
                    ...
                    b.HasIndex("TenantId", "Status")
                        .HasDatabaseName("ix_deals_tenant_id_status");

                    b.HasIndex("TenantId", "PipelineId", "IsDeleted")
                        .HasDatabaseName("ix_deals_tenant_id_pipeline_id_is_deleted");

                    b.HasIndex("TenantId", "StageId", "CreatedAt")
                        .HasDatabaseName("ix_deals_tenant_id_stage_id_created_at");

                    b.ToTable("deals", (string)null);
                });

            modelBuilder.Entity("TravelCrm.Api.Domain.Entities.Crm.DealActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_deal_activities");

                    b.HasIndex("DealId")
                        .HasDatabaseName("ix_deal_activities_deal_id");

                    b.HasIndex("TenantId", "DealId", "OccurredAt")
                        .HasDatabaseName("ix_deal_activities_tenant_id_deal_id_occurred_at");

                    b.ToTable("deal_activities", (string)null);
                });

            modelBuilder.Entity("TravelCrm.Api.Domain.Entities.Crm.GoogleOAuthToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_google_oauth_tokens");

                    b.HasIndex("TenantId")
                        .IsUnique()
                        .HasDatabaseName("ix_google_oauth_tokens_tenant_id");

                    b.ToTable("google_oauth_tokens", (string)null);
                });

            modelBuilder.Entity("TravelCrm.Api.Domain.Entities.Crm.LeadImportRowState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("ImportSourceId")
                        .HasColumnType("uuid")
                        .HasColumnName("import_source_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_lead_import_row_states");

                    b.HasIndex("ImportSourceId", "MatchKey")
                        .IsUnique()
                        .HasDatabaseName("ix_lead_import_row_states_import_source_id_match_key");

                    b.ToTable("lead_import_row_states", (string)null);
                });

            modelBuilder.Entity("TravelCrm.Api.Domain.Entities.Crm.LeadImportSource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("LastResultJson")
                        .HasColumnType("jsonb")
                        .HasColumnName("last_result_json");

                    b.Property<DateTime?>("LastSuccessAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_success_at");

                    b.Property<string>("MatchKeyField")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("match_key_field");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_lead_import_sources");

                    b.HasIndex("TenantId", "Status")
                        .HasDatabaseName("ix_lead_import_sources_tenant_id_status");

                    b.ToTable("lead_import_sources", (string)null);
                });

            modelBuilder.Entity("TravelCrm.Api.Domain.Entities.Crm.LeadImportStaging", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_lead_import_staging");

                    b.HasIndex("TenantId", "CreatedAt")
                        .HasDatabaseName("ix_lead_import_staging_tenant_id_created_at");

                    b.ToTable("lead_import_staging", (string)null);
                });

            modelBuilder.Entity("TravelCrm.Api.Domain.Entities.Crm.Pipeline", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_pipelines_tenant_id_name");

                    b.HasIndex("TenantId", "SortOrder")
                        .HasDatabaseName("ix_pipelines_tenant_id_sort_order");

                    b.ToTable("pipelines", (string)null);
                });

            modelBuilder.Entity("TravelCrm.Api.Domain.Entities.Crm.PipelineStage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("PipelineId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_pipeline_stages_pipeline_id_name");

                    b.HasIndex("TenantId", "PipelineId", "SortOrder")
                        .HasDatabaseName("ix_pipeline_stages_tenant_id_pipeline_id_sort_order");
            ...
            modelBuilder.Entity("TravelCrm.Api.Domain.Entities.Subscriptions.Plan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal?>("AnnualPricePerMonth")
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("annual_price_per_month");

                    b.Property<int?>("ChatLicenseLimit")
                        .HasColumnType("integer")
                        .HasColumnName("chat_license_limit");
                    ...
                    b.Property<int?>("DepartmentLimit")
                        .HasColumnType("integer")
                        .HasColumnName("department_limit");
                    ...
                    b.Property<decimal?>("FlatMonthlyPrice")
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("flat_monthly_price");

                    b.Property<bool>("IsActive")
                        .HasColumnType("boolean")
                        .HasColumnName("is_active");

                    b.Property<bool>("IsContactSalesOnly")
                        .HasColumnType("boolean")
                        .HasColumnName("is_contact_sales_only");

                    b.Property<int?>("MarketingRuleLimit")
                        .HasColumnType("integer")
                        .HasColumnName("marketing_rule_limit");
                    ...
                    b.Property<int?>("RoleLimit")
                        .HasColumnType("integer")
                        .HasColumnName("role_limit");
                    ...
                    b.Property<int?>("WebhookLimit")
                        .HasColumnType("integer")
                        .HasColumnName("webhook_limit");

                    b.Property<int?>("WorkflowRuleLimit")
                        .HasColumnType("integer")
                        .HasColumnName("workflow_rule_limit");
            ...
            modelBuilder.Entity("TravelCrm.Api.Domain.Entities.Subscriptions.PlanFeature", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("PlanId", "FeatureCode")
                        .IsUnique()
                        .HasDatabaseName("ix_plan_features_plan_id_feature_code");

                    b.ToTable("plan_features", (string)null);
                });

            modelBuilder.Entity("TravelCrm.Api.Domain.Entities.Subscriptions.TenantSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("Status", "CurrentPeriodEnd")
                        .HasDatabaseName("ix_tenant_subscriptions_status_current_period_end");

                    b.HasIndex("Status", "TrialEndsAt")
                        .HasDatabaseName("ix_tenant_subscriptions_status_trial_ends_at");
            ...
            modelBuilder.Entity("TravelCrm.Api.Domain.Entities.Crm.Deal", b =>
                {
                    b.HasOne("TravelCrm.Api.Domain.Entities.Crm.Pipeline", null)
                        .WithMany()
                    ...
                    b.HasOne("TravelCrm.Api.Domain.Entities.Crm.PipelineStage", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TravelCrm.Api.Domain.Entities.Crm.DealActivity", b =>
                {
                    b.HasOne("TravelCrm.Api.Domain.Entities.Crm.Deal", null)
                        .WithMany()
                        .HasForeignKey("DealId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_deal_activities_deals_deal_id");
                });

            modelBuilder.Entity("TravelCrm.Api.Domain.Entities.Crm.LeadImportRowState", b =>
                {
                    b.HasOne("TravelCrm.Api.Domain.Entities.Crm.LeadImportSource", null)
                        .WithMany()
                        .HasForeignKey("ImportSourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_lead_import_row_states_lead_import_sources_import_source_id");
                });
            ...
            modelBuilder.Entity("TravelCrm.Api.Domain.Entities.Subscriptions.PlanFeature", b =>
                {
                    b.HasOne("TravelCrm.Api.Domain.Entities.Subscriptions.Plan", null)
                        .WithMany("Features")
            ...
            modelBuilder.Entity("TravelCrm.Api.Domain.Entities.Subscriptions.TenantSubscription", b =>
                {
                    ...
                    b.HasOne("TravelCrm.Api.Domain.Entities.Tenant", null)
                        .WithOne()
                        .HasForeignKey("TravelCrm.Api.Domain.Entities.Subscriptions.TenantSubscription", "TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
